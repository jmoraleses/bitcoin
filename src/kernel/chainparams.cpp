...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"); // 804000 0x00000000000000000001a0a448d6cf2546b06801389cc030b2b18c6491266815
        ...
        vSeeds.emplace_back("seed.hyperultracoin.com.");
...
public:
    CTestNetParams() {
        ...
        consensus.SegwitHeight = 1; // 1; // segwit activation height + miner confirmation window
        consensus.powLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 10 * 60;
        ...
        vSeeds.emplace_back("testnet-seed.hyperultracoin.com.");
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("signet-seed.hyperultracoin.com.");
